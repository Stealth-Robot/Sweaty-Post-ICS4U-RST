...
public class RailwayScene extends Scene {
	...
	public void createEnvironment() {
		...
		for (int x = 0; x < 9; x++) {
			for (int y = 0; y < 6; y++) {
				...
				if (x == 1 && y == 5 || x == 2 && y == 5 || x == 2 && y == 4 || x == 3 && y == 5 || x == 3 && y == 4
						|| x == 4 && y == 5)
		...
		//"Welcome to Sweaty Post! you have accadently released a bunch of bad bois and you have been tasked with recatching them."
	...
	public void createColliders() {
		...
		addCollider(new SceneChangeColliderNoInteract(RectangleCreator.colliderRectangle(4, 1.95),
				SceneMaster.railwayIScene, new Vector2(4, 1), Player.Movement.NORTH, Player.Movement.NORTH));
